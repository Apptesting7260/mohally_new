...
class ArabicCategorySearchScreen extends StatefulWidget {
  const ArabicCategorySearchScreen({Key? key}) : super(key: key);

  @override
  State<ArabicCategorySearchScreen> createState() =>
      _ArabicCategorySearchScreenState();
}

class _ArabicCategorySearchScreenState
    extends State<ArabicCategorySearchScreen> {
  TextEditingController searchController = TextEditingController();
  ArabicCategorySearchController _searchcontroller =
